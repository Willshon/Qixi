var Qixi = function() {
    var confi = {
        ...
        audio: {
            enable: true,
            playURl: "./media/happy.wav",
            cycleURL: "./media/circulation.wav"
        },
        setTime: {
            walkToThird: 6000,
            walkToMiddle: 6500,
        ...
        snowflakeURl: ["./img/55adde120001d34e00410041.png", "./img/55adde2a0001a91d00410041.png", "./img/55adde5500013b2500400041.png", "./img/55adde62000161c100410041.png", "./img/55adde7f0001433000410041.png", "./img/55addee7000117b500400041.png"]
    };
    var debug = 0;
    if (debug) {
